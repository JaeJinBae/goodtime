...
$(function(){
	...
	$(document).on("click", ".doctor_time_table .reservation_register_btn", function(){
		...
		$(".popup_clinic_reservation_register > h2").append(str);
	...
	$(document).on("click", ".therapist_time_table .reservation_register_btn", function(){
		...
		str = "<input type='hidden' name='pno' value='"+pno+"'><input type='hidden' name='pname' value='"+pname+"'><input type='hidden' name='chart_no' value='"+chart_no+"'>";
		$(".popup_therapy_reservation_register > h2").append(str);
...
<body>
	<div class="popup_wrap">
		<jsp:include page="../include/nurseViewPopup.jsp"></jsp:include>
	</div><!-- popup_wrap end -->
