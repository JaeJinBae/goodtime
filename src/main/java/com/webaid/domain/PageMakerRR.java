...
public class PageMakerRR {
	...
	public String toString() {
		return "PageMakerRR [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage + ", prev="
	...
	public String makeSearch(int page){
		UriComponents uriComponents=UriComponentsBuilder.newInstance().queryParam("page", page)
																		...
																		.queryParam("keyword1", ((SearchCriteriaRR)cri).getKeyword1())
																		.queryParam("keyword2", ((SearchCriteriaRR)cri).getKeyword2())
																		.queryParam("keyword3", ((SearchCriteriaRR)cri).getKeyword3())
																		.queryParam("keyword4", ((SearchCriteriaRR)cri).getKeyword4()).build();
