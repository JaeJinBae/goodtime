...
public class PageMaker5 {
	...
	private Criteria5 cri;// 현재 페이지 번호를 알아야 시작과 끝을 구할 수 있음
	...
	public Criteria5 getCri() {
		return cri;
	}

	public void setCri(Criteria5 cri) {
		this.cri = cri;
	}

	@Override
	public String toString() {
		return "PageMaker5 [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage + ", prev="
	...
	public String makeSearch(int page){
		UriComponents uriComponents=UriComponentsBuilder.newInstance().queryParam("page", page)
																		...
																		.queryParam("searchType", ((SearchCriteria5)cri).getSearchType())
																		.queryParam("keyword", ((SearchCriteria5)cri).getKeyword()).build();
